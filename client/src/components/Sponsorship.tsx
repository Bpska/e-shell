    ...
    <section id="sponsorship" className="py-24 bg-gradient-to-br from-[#F7E7C6] via-white to-[#F7E7C6] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-24">
          ...
          <p className="text-xl md:text-2xl text-gray-500 max-w-3xl mx-auto font-bold tracking-tight">
                ...
                <ul className="space-y-6">
                  {tier.benefits.map((benefit, idx) => (
                    <li key={idx} className="flex items-start gap-4">
                      ...
                      <span className="text-gray-700 font-bold text-sm md:text-base leading-relaxed">{benefit}</span>
                    </li>
                  ))}
                </ul>
              </div>
