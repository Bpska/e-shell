        ...
        <div className="space-y-6">
          {faqs.map((faq, index) => (
            ...
            >
              ...
              >
                <span className="font-black text-[#7A1F1F] text-base sm:text-xl md:text-2xl tracking-tight uppercase italic pr-4">{faq.question}</span>
              ...
              {openIndex === index && (
                <div className="px-8 pb-8 animate-fadeIn">
                  ...
                  <p className="text-base sm:text-xl md:text-lg text-gray-700 font-bold leading-relaxed">{faq.answer}</p>
                </div>
              )}
            </div>
          ))}
