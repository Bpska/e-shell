    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#F7E7C6] via-[#D9B68C] to-[#F7E7C6] pt-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
        <div className="animate-fadeIn">
          ...
          <h1 className="text-6xl md:text-8xl lg:text-9xl font-extrabold text-[#7A1F1F] mb-6 tracking-tighter uppercase leading-none italic">
            UTKALPRENEUR
          ...
          <div className="mb-12 space-y-4 animate-slideInUp" style={{ animationDelay: '0.2s' }}>
            <p className="text-2xl md:text-4xl text-[#000000] font-bold tracking-tight">
              "Rooted in Tradition, Rising with Enterprise"
            </p>
            <p className="text-xl md:text-2xl text-[#7A1F1F] font-medium opacity-80">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-12 animate-slideInUp" style={{ animationDelay: '0.4s' }}>
            ...
            <div className="flex items-center gap-4 px-6 py-3 bg-white/50 backdrop-blur-sm rounded-2xl border border-[#7A1F1F]/10 shadow-sm">
              ...
              <div className="text-left">
                ...
                <p className="font-bold text-[#000000]">March 22 - 23, 2026</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 animate-slideInUp" style={{ animationDelay: '0.6s' }}>
            <button
              ...
              className="premium-button group px-10 py-5 bg-[#7A1F1F] text-[#F7E7C6] rounded-2xl font-black text-xl hover:bg-[#D4A017] hover:text-[#000000] transition-all flex items-center gap-3 border-b-4 border-[#5A1515]"
            >
              REGISTER NOW
            ...
            <button
              ...
              className="premium-button px-10 py-5 bg-white text-[#7A1F1F] rounded-2xl font-black text-xl hover:bg-[#F7E7C6] transition-all border-b-4 border-gray-200"
            >
              SPONSOR US
            </button>
          </div>
